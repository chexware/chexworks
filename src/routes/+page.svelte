...
<div>
  ...
  <div class="grid grid-cols-6 grid-rows-6 gap-0 w-full h-full content-center dedgy max-lg:pt-10" >
    ...
    <div class="dedgy max-lg:row-span-1 max-lg:order-4 max-lg:text-center lg:col-start-2 lg:col-span-2 max-lg:col-span-6" role="presentation">
      <a href="/contact" class="lg:text-8xl max-lg:text-6xl hover:text-white" on:mouseover={showDedgy} on:mouseout={hideDedgy} on:mousemove={moveDedgy} >Contact</a>
    </div>
     <!-- svelte-ignore a11y-mouse-events-have-key-events -->
    ...
    <div class="row-span-1  col-span-6 max-lg:hidden lg:visible"></div>
     <!-- svelte-ignore a11y-mouse-events-have-key-events -->
    <div id="about-section" class="dedg ymax-lg:pr-20 max-lg:row-span-1 max-lg:order-1 max-lg:content-center lg:col-start-4 lg:col-span-2  max-lg:pl-20" on:mouseover={showDedgy} on:mouseout={hideDedgy} on:mousemove={moveDedgy} role="presentation">
      <div class="max-lg:pl-20">
          <div class="sm:max-lg:pl-20">
            <div class="md:max-lg:pl-20">
              <button type="button" class="flex items-end gap-2 border-none" data-hs-overlay="#hs-about-modal">
    ...
    <div class="max-lg:row-span-1 max-lg:order-3 max-lg:text-center lg:col-start-3 lg:col-end-6 max-lg:col-span-6" role="presentation">
      <a href="/blog" class="lg:text-8xl max-lg:text-6xl hover:text-white" on:mouseover={showDedgy} on:mouseout={hideDedgy} on:mousemove={moveDedgy}>?Technology</a>
    </div>
